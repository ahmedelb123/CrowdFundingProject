document.addEventListener('DOMContentLoaded', () => {
    ...
    // DOM element to show donation feedback
    ...
    confirmDonateButton.addEventListener('click', async () => {
        ...
        try {
            ...
            if (!response.ok) {
                // Show the error message from the backend, if any
                ...
                // Refresh campaign data (assuming these functions exist in another script)
